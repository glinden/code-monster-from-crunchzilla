...
<p>Code Monster use Javascript.  Please enable Javascript if you want the play with the Code Monster.  Otherwise, Code Monster will not be able to play with you.</p>
</h2>
</noscript>

<div class=not-selectable unselectable=on id=language-flags>
	<div class="us-flag-holder" onclick="language='en'; initLesson();">
		<div class="us-flag"></div>
	</div>
	<div class="de-flag-holder" onclick="language='de'; initLesson();">
		<div class="de-flag"></div>
	</div>
	<div class="jp-flag-holder" onclick="language='jp'; initLesson();">
...
<div class=not-selectable unselectable=on id=tutor>
	<div id=tutor-avatar unselectable=on><img id=tutor-img unselectable=on src=tutor0.png /></div>
...
<div class="simplemodal-close simplemodal-closex">X</div>
	...
	<script type="text/javascript" src=thirdparty/codemirror.js></script>
	<script type="text/javascript" src=thirdparty/codemirror-javascript.js></script>
	<script type="text/javascript" src=thirdparty/jshint.js></script>
	<script type="text/javascript" src=thirdparty/jquery-1.7.2.min.js></script>
	<script type="text/javascript" src=thirdparty/jquery.simplemodal.1.4.2.min.js></script>
	<script type="text/javascript" src=codemonster-lessons.js></script>
	<script type="text/javascript" src="codemonster-i18n.js"></script>
	<script type="text/javascript" src=codemonster.js></script>
